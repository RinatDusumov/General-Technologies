create database home_work_gentech;
...
-- select * from staff
-- where firstname like 'Tom' and position like 'Middle%';

-- select * from staff
-- where lastname like 'Lorentz' and has_child = 'N' and position like 'Junior%';
